        ...
        <table>
            ...
            <td>
                <select name="ligue" id="ligue">
                    ...
                    <option value="2">Ligue de Judo Auvergne-Rhône-Alpes</option>
                    <option value="3">Ligue de footbal de Haute-Garonne</option>
                    <option value="4">Ligue de footbal Aquitaine</option>
                    <option value="5">Ligue de tennis de Corse du Sud</option>
                    <object value="6">Ligue équitation du Var</object>
                    <object value="5">Ligue de natation du Quercy</object>
                </select>
            </td>
            </tr>
            <tr>
